Shader "Custom/OutlineSprite"
{
	...
	_Color("Test Color", Color) = (1,1,1,1)
		_OutlineDist("Outline Sample Distance", Range(0, 20)) = 2.0
	}
		SubShader
	{
		Tags
...
#include "UnityCG.cginc"
	...
	// These three lines create the colored outline. Removing them will create an outline that is always black.
	col.r = max(_Color.r * (1 - col.a), col.r);
	col.g = max(_Color.g * (1 - col.a), col.g);
	col.b = max(_Color.b * (1 - col.a), col.b);
	return col;
	}
		ENDCG
	}
